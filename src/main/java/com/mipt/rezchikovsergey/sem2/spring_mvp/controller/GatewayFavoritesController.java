...
public class GatewayFavoritesController {
  ...
  public ResponseEntity<Void> addToFavorites(@PathVariable UUID taskId) {
  ...
  public ResponseEntity<Void> remove(@PathVariable UUID taskId) {
  ...
  public ResponseEntity<List<TaskResponseDto>> getFavorites() {
    return ResponseEntity.ok(favoritesService.getFavoriteTasks());
  }
}
