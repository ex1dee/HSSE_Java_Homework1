...
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.IntegerRange;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.MultipleInvalid;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NotIntegerRange;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NotNullField;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NotStringEmail;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NotStringSize;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NullEmail;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.NullField;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.RangeOfNull;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.SizeOfNull;
import com.mipt.rezchikovsergey.sem1.annotations_reflections.test_classes.StringSize;
...
class ValidatorTest {
  ...
  private void assertValidation(
      ValidationResult result, boolean expectedValid, int expectedErrorsNum) {
