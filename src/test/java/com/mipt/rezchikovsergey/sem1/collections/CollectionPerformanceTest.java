...
public class CollectionPerformanceTest {
  ...
  public void compareListsPerformance() {
    ...
    long arrayListAddToEndMeasure = measureOperation(new ArrayList<>(), addToEndOperation);
    long arrayListAddToBeginMeasure = measureOperation(new ArrayList<>(), addToBeginOperation);
    long arrayListInsertToMiddleMeasure =
        measureOperation(new ArrayList<>(), insertToMiddleOperation);

    long arrayListGetElementMeasure = measureOperation(new ArrayList<>(list), getElementOperation);
    ...
    long linkedListAddToEndMeasure = measureOperation(new LinkedList<>(), addToEndOperation);
    long linkedListAddToBeginMeasure = measureOperation(new LinkedList<>(), addToBeginOperation);
